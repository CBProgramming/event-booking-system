...
namespace ThAmCo.Events.Data.Migrations
{
    ...
    [Migration("20191201131241_eventSoftDelete")]
    partial class eventSoftDelete
    {
            ...
            modelBuilder.Entity("ThAmCo.Events.Data.Event", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, Date = new DateTime(2016, 4, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 6, 0, 0, 0), IsActive = false, Title = "Bob's Big 50", TypeId = "PTY", VenueCapacity = 150, VenueCost = 100.0, VenueDescription = "", VenueName = "Crackling Hall", VenueRef = "" },
                        new { Id = 2, Date = new DateTime(2018, 12, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Duration = new TimeSpan(0, 12, 0, 0, 0), IsActive = false, Title = "Best Wedding Yet", TypeId = "WED", VenueCapacity = 150, VenueCost = 100.0, VenueDescription = "", VenueName = "Crackling Hall", VenueRef = "" }
                    );
                });
